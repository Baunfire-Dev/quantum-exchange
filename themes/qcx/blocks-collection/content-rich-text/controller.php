...
if (in_array($post_type, ['post', 'ebook', 'webinar', 'customer-story', 'press'])) {
    ...
    $context["res_sidebar_enabled"] = get_field("resource_sidebar_enabled", get_the_ID());
    $context["res_toc_enabled"] = get_field("resource_table_of_contents", get_the_ID());
    $context["res_form"] = get_field("resource_form", get_the_ID());
    $context["res_letter_enabled"] = get_field("resource_newsletter", get_the_ID());
