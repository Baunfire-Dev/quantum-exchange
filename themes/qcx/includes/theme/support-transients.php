<?php
define('TRANSIENT_PREFIX', 'qcx');
define('TRANSIENT_DURATION', 7 * DAY_IN_SECONDS);

$post_type_transient_map = [
    'solution'       => ['grid_solutions'],
    'post'           => ['post_grid_resource'],
    'press'          => ['block_grid_press'],
    'webinar'        => ['webinar_grid_resource'],
    'ebook'          => ['ebook_grid_resource'],
    'customer-story' => ['customer-story_grid_resource'],
];
...
function clear_transients(array $transient_names = []) {
    ...
    if (empty($transient_names)) {
        // If no specific transients, clear all with prefix
    ...
    // Clear only specific transients
